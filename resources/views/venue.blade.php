        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    ...
                    <p class="mb-5"><strong class="h2 text-success font-weight-bold">ksh {{ $venue->price_per_hour }}</strong></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8" style="margin-top: -150px;">
                    <div class="mb-5">
                        <div class="slide-one-item home-slider owl-carousel">
                            <div><img src="{{ 'http://localhost:8000/images/'.$venue->main_photo->name.'.jpg' }}" alt="{{ $venue->name }}"
                                      class="img-fluid"></div>
                        </div>
                    </div>
                    <div class="bg-white">
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <strong class="text-success h1 mb-3">ksh{{ $venue->price_per_hour }}</strong>
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                                <span class="d-inline-block text-black mb-0 caption-text">Property Types</span>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                <a href="{{ $galleryItem->getFullUrl() }}" class="image-popup gal-item">
                                    <img src="{{ 'http://localhost:8000/images/'.$venue->main_photo->name.'.jpg' }}" alt="{{ $venue->name }} {{ $loop->iteration }}" class="img-fluid">
                                </a>
                            </div>
                            @endforeach
                        </div>
                ...
                @foreach ($relatedVenues as $venue)
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href="{{ route('venues.show', [$venue->slug, $venue->id]) }}" class="prop-entry d-block">
                            <figure>
                                <img src="{{ 'http://localhost:8000/images/'.$venue->main_photo->name.'.jpg' }}" alt="{{ $venue->name }}" class="img-fluid">
                            </figure>
                            <div class="prop-text">
                                <div class="inner">
                                    <span class="price rounded">ksh{{ $venue->price_per_hour }}</span>
