            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($venue->main_photo)
                                <a href="{{ 'http://localhost:8000/images/'.$venue->main_photo->name.'.jpg' }}" target="_blank">
                                    <img src="{{ 'http://localhost:8000/images/'.$venue->main_photo->name.'.jpg' }}" width="50px" height="50px">
                                </a>
                            @endif
                        </td>
                    </tr>
